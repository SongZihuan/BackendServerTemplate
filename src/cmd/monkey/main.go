...
import (
	"github.com/SongZihuan/BackendServerTemplate/src/cmdparser/monkey"
...
func main() {
	...
	exitutils.ErrorToExitQuite(monkey.GetMainCommand().Execute()).ClampAttribute().Exit()
}
